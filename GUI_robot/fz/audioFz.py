...
class ATINano17Reader:
    ...
    def get_data(self):
        with self.lock:
            return self.fz_data, self.timestamps, self.data_to_save
p = pyaudio.PyAudio()
...
def reset_data():
    global sum_temp_1, sum_temp_2, reset_cnt_1, reset_cnt_2
    sum_temp_1 = 0
    sum_temp_2 = 0
    reset_cnt_1 = 0
    reset_cnt_2 = 0
...
calibbtn = QPushButton("Calibrate Fz")
calibbtn.clicked.connect(lambda: daq_thread.reset_offset())
control_widget.addWidget(calibbtn, row=2, col=0)
